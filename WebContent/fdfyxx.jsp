...
<body>
	<div id="top">
			<a class="btn btn-info" href="querytgfdfy">我的房源</a>
			...
			<div id="fynr">
				...
				<s:iterator value="#request.list" var="fy">
					<li>
						...
						<div class="shqk">
							<p><s:if test="#fy[16]==null"><font color="#269ABC">待审核</font></s:if>
								<s:else>
									<font color="red">存在问题：${fy[16] }</font>
								</s:else>
							</p>
						</div>
					</li>
